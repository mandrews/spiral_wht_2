...
[x1,y1,e1,r1,z1,w1] = calc_model(n_tables{1}, 1.95, BETA, k, 1);
plot_scatter(x1, y1, 'suffix', 'model_seq1_a');

[x2,y2,e2,r2,z2,w2] = calc_model(n_tables{2}, 2.5, BETA, k, 1);
plot_scatter(x2, y2, 'suffix', 'model_seq2_a');

[x3,y3,e3,r3,z3,w3] = calc_model(n_tables{3}, 0.85, BETA, k, 1);
plot_scatter(x3, y3, 'suffix', 'model_seq3_a');

[x4a,y4a,e4a,r4a,z4a,w4a] = calc_model(n_tables{4}, 0.75, BETA, k, 1);
plot_scatter(x4a, y4a, 'suffix', 'model_vec1_a');

[x4b,y4b,e4b,r4b,z4b,w4b] = calc_model(n_tables{4}, 0.75, BETA, k, 0);
